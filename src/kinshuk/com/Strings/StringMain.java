...
import kinshuk.com.Static.StaticDemo;
import java.util.Scanner;
public class StringMain {
    public static void main(String[] args) {
        String str1 = new String("KB Pvt. Ltd.");
        String str2 = new String("KB Pvt. Ltd.").intern();
        System.out.println(str1 == str2); // false because 2 diff. references pointed
        System.out.println(str1.equals(str2)); // true because of same values
        String s1 = "John";
        String s2 = "John";
        ...
        if(s2 == s5){//s1 and s2 are references pointing to the same object in string pool
            System.out.println("s2 and s5 are equal");
        }
        else{
